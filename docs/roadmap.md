...
> scaffold #119 recut (2026-08-06, `8862f359`). Roadmap items below that
> assume a Blahaj-side receiver or handler (lane envs, dev-remote, public
> previews, webhook receiver) are retired-era: any successor lands in the
> app owner overlay, not at `tinyland-inc/blahaj`.
